...
$router->group(function () use ($router){
    ...
    // 权限
    $router->get('permissions/options', '\catchAdmin\permissions\controller\Permission@options');
    $router->get('permissions/modules', '\catchAdmin\permissions\controller\Permission@modules');
